...
export function PlayerPerson ({className}: PlayerPerson) {
    return(
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="757.964" height="743.732" viewBox="0 0 757.964 743.732">
